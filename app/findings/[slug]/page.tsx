  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 leading-relaxed text-neutral-300">{finding.summary}</p>
      </section>

      <section className="mt-10">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-emerald-400">Root cause</h2>
        <p className="mt-3 leading-relaxed text-neutral-300">{finding.rootCause}</p>
      </section>

      <section className="mt-10">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-emerald-400">Verification</h2>
        <p className="mt-3 leading-relaxed text-neutral-300">{finding.verification}</p>
